				...
				<div class="billing-form-item">
					...
					<div class="billing-content">
						<div class="contact-form-action">
							...
							<form id="submit-form" action="upload_camp.bam" method="post" enctype="multipart/form-data">
											...
											<div class="billing-form-item">
												<div class="billing-content">
													<div class="custom-checkbox" style='margin-bottom: 0px;'>
														<input type="checkbox" id="chk-sort-0-0" class="choice-sort" value="오토캠핑" onClick="chooseOnlyOneSort(this, 0);"> <label
															for="chk-sort-0-0">오토캠핑</label>
													</div>
													<div class="custom-checkbox" style='margin-bottom: 0px;'>
														<input type="checkbox" id="chk-sort-1-0" class="choice-sort" value="글램핑" onClick="chooseOnlyOneSort(this, 0);"> <label
															for="chk-sort-1-0">글램핑</label>
													</div>
													<div class="custom-checkbox" style='margin-bottom: 0px;'>
														<input type="checkbox" id="chk-sort-2-0" class="choice-sort" value="카라반" onClick="chooseOnlyOneSort(this, 0);"> <label
															for="chk-sort-2-0">카라반</label>
													</div>
													<div class="custom-checkbox" style='margin-bottom: 0px;'>
														<input type="checkbox" id="chk-sort-3-0" class="choice-sort" value="노지캠핑" onClick="chooseOnlyOneSort(this, 0);"> <label
															for="chk-sort-3-0">노지캠핑</label>
													</div>
													<div class="custom-checkbox" style='margin-bottom: 0px;'>
														<input type="checkbox" id="chk-sort-4-0" class="choice-sort" value="기타" onClick="chooseOnlyOneSort(this, 0);"> <label
